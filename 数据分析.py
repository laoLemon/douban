...
def plot_bar_chart_from_csv(file_path, ax=None):
    ...
    ax.set_ylabel('Count')
    ax.set_xticks(range(1, 6))  # 设置X轴刻度为评分1到5
    ax.grid(axis='y')  # 添加水平方向的网格线
    plt.tight_layout()  # 调整布局，避免标签重叠
...
if __name__ == '__main__':
    ...
    #plot_bar_chart_from_csv("./csv/clean/"+movie2024).show()